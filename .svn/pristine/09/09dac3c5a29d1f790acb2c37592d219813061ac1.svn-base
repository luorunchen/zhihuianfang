$(function () {
    ...
    function facTypeNum() {
        $.ajax({
            type: 'get',
            url: 'http://112.74.126.51/earlyWarn/earlyWarn/check_device_type.action',
    ...
    function AlarmInfor(day) {
        $.ajax({
            ...
            success: function (res) {
                ...
                $.each(res, function (i, v) {
                    // console.log(v);
                    html += "<li class='' data-did=" + v.did + " data-type=" + v.type + " data-name=" + v.name + "><p class='fl'><b style='color:red'>" + v.isTrafficname + "</b><br><span style='color:#3cf'>" + v.name + "</span>项目下设备号为<span style='color:#3cf'>" + v.deviceid + "</span>的设备因" + v.isTrafficname + "而产生报警<br></p><p class='fr pt17'>" + v.creationtime + "</p></li>"
                    $('#inforUl').html(html);
                })
    ...
    var openCom = function (comid, comName, type) {
        console.log(comid)
        console.log(comName)
        console.log(type)
