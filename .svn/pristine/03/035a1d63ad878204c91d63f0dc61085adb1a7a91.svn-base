    ...
    var loadEvent = function () {
        ...
        $(".queryBut").click(function () {
            ...
            $.each(lstCompany, function (i, v) {
                console.log(v);
                if (v.personliable.indexOf(txt) >= 0 || v.installLocation.indexOf(txt) >= 0 || v.deviceNo.indexOf(txt) >= 0) {
                    var thtml = "<div class=\"resultItem\">";
                    thtml += "<div class=\"resultTitle\">" + v.personliable + "</div>";
                    thtml += "<div class=\"resultText\">地址：" + v.installLocation + "</div>";
                    if (v.fireManagerTel && v.fireManagerTel != "") {
                        thtml += "<div class=\"resultText\">电话：" + v.liablephone + "</div>";
                    }
                    thtml += "</div>";
