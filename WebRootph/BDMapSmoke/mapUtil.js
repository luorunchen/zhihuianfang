...
var doAction = function (url, Type, param, backFun) {
    $.ajax({
        ...
        error: function (XMLHttpRequest, textStatus, errorThrown) {
            console.log("加载失败：" + textStatus + ":" + errorThrown + '6.html');
        },
        complete: function () {
...
var searchPos = function (mapObj) {
    //json/BDMap_FindArea.json
    var type = parseInt(localStorage.getItem('tpage'));
    console.log(type);
    var userName = parseInt(localStorage.getItem('userName'));
    doAction("http://112.74.126.51/earlyWarn/earlyWarn/admin/project/FindArea.action?username=" + userName, "GET", { type: type }, function (pp) {
        // doAction("http://zlh18122711575.55555.io:16799/earlyWarn/admin/project/FindArea.action?username="+userName, "GET", {type:type}, function (pp) {
        console.log(pp);
        var tZoom = parseInt(pp.MinLevel);  //9
