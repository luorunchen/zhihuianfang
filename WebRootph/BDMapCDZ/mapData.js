       ...
       console.log(data);
            ...
            if(data!=""&&data!=null){
               ...
               for(var i=0;i<data.length;i++){
                ...
                // console.log(marker);
                    var content =new BMap.Label("<div style='white-space:normal;color: #fff;background: url(../images/kjbg.png);box-shadow: inset 0px 0px 30px #fff;border-radius: 7px;padding:5px 0 0 12px; width:250px;height:90px;z-index:600'><p style='margin:0;'>设备名称:"+data[i].data.name+"</p><p style='margin:0;'>设备地址"+data[i].data.location+"</p></div>");
                    //<p style='margin:0;'>设备负责人:"+data[i].data.propeople+"</p><p style='margin:0;'>设备负责人电话:"+data[i].data.prophone+"</p>
                // console.log(content);
    ...
    var loadData = function () {
     ...
     //   doAction("http://zlh18122711575.55555.io:16799/earlyPlatform/admin/project/GetMapDataFire.action", "GET", {username:username,type:type}, function (result) {
          ...
          //  }
           ...
           // var NumStr = "000000" + result.gas[0].all_dev;
